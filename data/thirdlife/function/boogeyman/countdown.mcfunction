...
execute if score #countdown countdown matches 0.. run schedule function thirdlife:boogeyman/countdown 1s
execute if score #countdown countdown matches ..-1 run schedule function thirdlife:boogeyman/notice 2s