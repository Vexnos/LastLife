...
tellraw @s ["",{"text":"You gave a life to ","color":"white"},{"selector":"@a[tag=gift,limit=1]"},{"text":"!","color":"green"}]
tellraw @a[tag=gift,limit=1] ["",{"text":"You received a life from ","color":"white"},{"selector":"@a[tag=giver,limit=1]"},{"text":"!","color":"green"}]
